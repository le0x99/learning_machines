class Agent(robobo.SimulationRobobo):
    def __init__(self, ip='192.168.1.133',
        ...
        self.critic = Critic()
        self.actor = Actor()
        self.optim_c = optim.Adam(self.critic.parameters(), lr=0.1)
        self.optim_a = optim.Adam(self.actor.parameters(), lr=0.1)
    ...
    def act(self):
        ...
        advantage = target - prediction_state
        log_probs = action_dists.log_prob(action)
        loss_actor = (-log_probs * advantage.clone()).mean() - entropy
